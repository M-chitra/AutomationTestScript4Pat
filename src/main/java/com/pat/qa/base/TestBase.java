...
import com.pat.qa.util.Constant;
	...
	public TestBase() {
		...
		try {
			...
			FileInputStream fip = new FileInputStream(
					"C:/Users/chitra/Automation Assesment/PatAssessment/src/main/java/com/pat/qa/config/config.properties");
			prop.load(fip);
	...
	public static void initialization() {
		...
		if (browserName.equals("chrome")) {
			System.setProperty("webdriver.chrome.driver",
					"C:/Users/chitra/Downloads/chromedriver-win32/chromedriver-win32/chromedriver.exe");
